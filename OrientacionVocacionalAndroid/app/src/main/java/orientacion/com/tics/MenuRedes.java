...
public class MenuRedes extends AppCompatActivity {
	...
	private void setCheckBox() {
		...
		preguntaNameTxt.setText(getResources().getString(R.string.tics2));
		radioButtonA.setText(getResources().getString(R.string.pregunta11));
		radioButtonB.setText(getResources().getString(R.string.pregunta12));
		radioButtonC.setText(getResources().getString(R.string.pregunta13));
		radioButtonD.setText(getResources().getString(R.string.pregunta14));
		radioButtonE.setText(getResources().getString(R.string.pregunta15));
		radioButtonF.setText(getResources().getString(R.string.pregunta16));
	...
	private void initService() {
		...
		Call<ResponseBase> call = apiInterface.registrarTicsRedes(idAlumno, tics1, tics2, tics3, tics4, tics5, tics6);
	...
	private void pasarSiguiente(Response<ResponseBase> response) {
		Intent intent = new Intent(activity, MenuAlmacenamiento.class);
